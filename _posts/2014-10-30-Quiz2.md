...
<style>
.thing {position:absolute;right: 0px; top: 0px; border: 2px; border-style: double; background-color: white; margin: 5px; padding: 5px; }
...
function setupgame() {
 ...
 for(i=0;i<nq;i++) {
  ...
  thingelem.style.left = String(mx)+"px"+500;
